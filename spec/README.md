...
4      CONTENT-OPERATIONS    글·프로젝트를 쓰고 옮기는 절차
...
| [3-2-DESIGN-DECISIONS](3-2-DESIGN-DECISIONS.md) | 주요 결정과 근거, 재검토 조건, 시각 언어의 출처, 콘텐츠 정책 |
| [4-CONTENT-OPERATIONS](4-CONTENT-OPERATIONS.md) | 글·프로젝트 작성 규칙, 티스토리 이관 절차 |
...
4. 이력·연락처 항목을 넣거나 빼면 [3-2](3-2-DESIGN-DECISIONS.md) §3-2-7에 판단과 근거를 남긴다. `MUST`
